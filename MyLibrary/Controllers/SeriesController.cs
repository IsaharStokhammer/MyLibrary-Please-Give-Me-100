...
namespace MyLibrary.Controllers
{
    public class SeriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ShelfId,Name,genreName")] Serie serie)
        {
            var genre = await _context.Genre.FirstOrDefaultAsync(g => g.Name == serie.genreName);
            if (genre == null)
            {
